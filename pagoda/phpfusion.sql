...
DROP TABLE IF EXISTS `pagoda_admin`;
CREATE TABLE `pagoda_admin` (
...
INSERT INTO `pagoda_admin` (`admin_id`, `admin_rights`, `admin_image`, `admin_title`, `admin_link`, `admin_page`) VALUES
...
(48,	'UL',	'user_fields.gif',	'User Log',	'user_log.php',	2),
(49,	'ROB',	'robots.gif',	'robots.txt',	'robots.php',	3);

DROP TABLE IF EXISTS `pagoda_admin_resetlog`;
CREATE TABLE `pagoda_admin_resetlog` (
...
DROP TABLE IF EXISTS `pagoda_article_cats`;
CREATE TABLE `pagoda_article_cats` (
...
DROP TABLE IF EXISTS `pagoda_articles`;
CREATE TABLE `pagoda_articles` (
...
DROP TABLE IF EXISTS `pagoda_bbcodes`;
CREATE TABLE `pagoda_bbcodes` (
...
INSERT INTO `pagoda_bbcodes` (`bbcode_id`, `bbcode_name`, `bbcode_order`) VALUES
(1,	'smiley',	1),
(2,	'b',	2),
(3,	'i',	3),
(4,	'u',	4),
...
DROP TABLE IF EXISTS `pagoda_blacklist`;
CREATE TABLE `pagoda_blacklist` (
...
DROP TABLE IF EXISTS `pagoda_captcha`;
CREATE TABLE `pagoda_captcha` (
...
DROP TABLE IF EXISTS `pagoda_comments`;
CREATE TABLE `pagoda_comments` (
...
DROP TABLE IF EXISTS `pagoda_custom_pages`;
CREATE TABLE `pagoda_custom_pages` (
...
DROP TABLE IF EXISTS `pagoda_download_cats`;
CREATE TABLE `pagoda_download_cats` (
...
DROP TABLE IF EXISTS `pagoda_downloads`;
CREATE TABLE `pagoda_downloads` (
...
DROP TABLE IF EXISTS `pagoda_email_verify`;
CREATE TABLE `pagoda_email_verify` (
...
DROP TABLE IF EXISTS `pagoda_errors`;
CREATE TABLE `pagoda_errors` (
...
DROP TABLE IF EXISTS `pagoda_faq_cats`;
CREATE TABLE `pagoda_faq_cats` (
...
DROP TABLE IF EXISTS `pagoda_faqs`;
CREATE TABLE `pagoda_faqs` (
...
DROP TABLE IF EXISTS `pagoda_flood_control`;
CREATE TABLE `pagoda_flood_control` (
...
DROP TABLE IF EXISTS `pagoda_forum_attachments`;
CREATE TABLE `pagoda_forum_attachments` (
...
DROP TABLE IF EXISTS `pagoda_forum_poll_options`;
CREATE TABLE `pagoda_forum_poll_options` (
...
DROP TABLE IF EXISTS `pagoda_forum_poll_voters`;
CREATE TABLE `pagoda_forum_poll_voters` (
  `thread_id` mediumint(8) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `pagoda_forum_polls`;
CREATE TABLE `pagoda_forum_polls` (
  `thread_id` mediumint(8) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `pagoda_forum_ranks`;
CREATE TABLE `pagoda_forum_ranks` (
...
INSERT INTO `pagoda_forum_ranks` (`rank_id`, `rank_title`, `rank_image`, `rank_posts`, `rank_type`, `rank_apply`) VALUES
...
DROP TABLE IF EXISTS `pagoda_forums`;
CREATE TABLE `pagoda_forums` (
...
DROP TABLE IF EXISTS `pagoda_infusions`;
CREATE TABLE `pagoda_infusions` (
...
DROP TABLE IF EXISTS `pagoda_messages`;
CREATE TABLE `pagoda_messages` (
...
DROP TABLE IF EXISTS `pagoda_messages_options`;
CREATE TABLE `pagoda_messages_options` (
...
INSERT INTO `pagoda_messages_options` (`user_id`, `pm_email_notify`, `pm_save_sent`, `pm_inbox`, `pm_savebox`, `pm_sentbox`) VALUES
(0,	0,	1,	20,	20,	20);

DROP TABLE IF EXISTS `pagoda_new_users`;
CREATE TABLE `pagoda_new_users` (
...
DROP TABLE IF EXISTS `pagoda_news`;
CREATE TABLE `pagoda_news` (
...
DROP TABLE IF EXISTS `pagoda_news_cats`;
CREATE TABLE `pagoda_news_cats` (
...
INSERT INTO `pagoda_news_cats` (`news_cat_id`, `news_cat_name`, `news_cat_image`) VALUES
(1,	'Bugs',	'bugs.gif'),
...
DROP TABLE IF EXISTS `pagoda_online`;
CREATE TABLE `pagoda_online` (
...
INSERT INTO `pagoda_online` (`online_user`, `online_ip`, `online_ip_type`, `online_lastactive`) VALUES
('0',	'127.0.0.1',	4,	1359293110);

DROP TABLE IF EXISTS `pagoda_panels`;
CREATE TABLE `pagoda_panels` (
...
INSERT INTO `pagoda_panels` (`panel_id`, `panel_name`, `panel_filename`, `panel_content`, `panel_side`, `panel_order`, `panel_type`, `panel_access`, `panel_display`, `panel_status`, `panel_url_list`, `panel_restriction`) VALUES
...
DROP TABLE IF EXISTS `pagoda_photo_albums`;
CREATE TABLE `pagoda_photo_albums` (
...
DROP TABLE IF EXISTS `pagoda_photos`;
CREATE TABLE `pagoda_photos` (
...
DROP TABLE IF EXISTS `pagoda_poll_votes`;
CREATE TABLE `pagoda_poll_votes` (
...
DROP TABLE IF EXISTS `pagoda_polls`;
CREATE TABLE `pagoda_polls` (
...
DROP TABLE IF EXISTS `pagoda_posts`;
CREATE TABLE `pagoda_posts` (
...
DROP TABLE IF EXISTS `pagoda_ratings`;
CREATE TABLE `pagoda_ratings` (
...
DROP TABLE IF EXISTS `pagoda_settings`;
CREATE TABLE `pagoda_settings` (
  `settings_name` varchar(200) NOT NULL DEFAULT '',
  `settings_value` text NOT NULL,
  PRIMARY KEY (`settings_name`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

INSERT INTO `pagoda_settings` (`settings_name`, `settings_value`) VALUES
...
('sitebanner1',	''),
('sitebanner2',	''),
('siteemail',	'changeme@pagodabox.com'),
('siteusername',	'admin'),
('siteintro',	'<div style=\\\'text-align:center\\\'>Welcome to your PHP-Fusion powered by Pagodabox.<br/>Login with credentials:<br/>\r\nusername: admin<br/>\r\npassword: admin1234<br/>\r\nprivileged password: superadmin<br/>\r\n<br/>\r\nPlease login and change them immediately from your user profile!<br/>\r\n<br/>\r\n</div>'),
('description',	''),
('keywords',	''),
('footer',	'<div style=\\\'text-align:center\\\'>Copyright &copy; 2013</div>'),
...
('avatar_ratio',	'0'),
('cronjob_day',	'1359292940'),
('cronjob_hour',	'1359292940'),
('flood_autoban',	'1'),
...
DROP TABLE IF EXISTS `pagoda_settings_inf`;
CREATE TABLE `pagoda_settings_inf` (
  `settings_name` varchar(200) NOT NULL DEFAULT '',
  `settings_value` text NOT NULL,
...
DROP TABLE IF EXISTS `pagoda_site_links`;
CREATE TABLE `pagoda_site_links` (
...
INSERT INTO `pagoda_site_links` (`link_id`, `link_name`, `link_url`, `link_visibility`, `link_position`, `link_window`, `link_order`) VALUES
...
DROP TABLE IF EXISTS `pagoda_smileys`;
CREATE TABLE `pagoda_smileys` (
...
INSERT INTO `pagoda_smileys` (`smiley_id`, `smiley_code`, `smiley_image`, `smiley_text`) VALUES
(1,	':)',	'smile.gif',	'Smile'),
(2,	';)',	'wink.gif',	'Wink'),
(3,	':(',	'sad.gif',	'Sad'),
(4,	':|',	'frown.gif',	'Frown'),
...
DROP TABLE IF EXISTS `pagoda_submissions`;
CREATE TABLE `pagoda_submissions` (
...
DROP TABLE IF EXISTS `pagoda_suspends`;
CREATE TABLE `pagoda_suspends` (
...
DROP TABLE IF EXISTS `pagoda_thread_notify`;
CREATE TABLE `pagoda_thread_notify` (
  `thread_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `pagoda_threads`;
CREATE TABLE `pagoda_threads` (
  `forum_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `pagoda_user_field_cats`;
CREATE TABLE `pagoda_user_field_cats` (
...
INSERT INTO `pagoda_user_field_cats` (`field_cat_id`, `field_cat_name`, `field_cat_order`) VALUES
(1,	'Contact Information',	1),
(2,	'Miscellaneous Information',	2),
(3,	'Options',	3),
(4,	'Statistics',	4);

DROP TABLE IF EXISTS `pagoda_user_fields`;
CREATE TABLE `pagoda_user_fields` (
...
INSERT INTO `pagoda_user_fields` (`field_id`, `field_name`, `field_cat`, `field_required`, `field_log`, `field_registration`, `field_order`) VALUES
...
DROP TABLE IF EXISTS `pagoda_user_groups`;
CREATE TABLE `pagoda_user_groups` (
...
DROP TABLE IF EXISTS `pagoda_user_log`;
CREATE TABLE `pagoda_user_log` (
...
DROP TABLE IF EXISTS `pagoda_users`;
CREATE TABLE `pagoda_users` (
...
DROP TABLE IF EXISTS `pagoda_weblinks`;
CREATE TABLE `pagoda_weblinks` (
